    ...
    function response(x) {
        ...
        for (var i = 0; i < x.feed.entry.length; i++) {                             
            ...
            _.each(feature, function(value, key) {
                if(feature.properties['title']=="luz"){ feature.properties['marker-color']='#CB3344'} 
                if(feature.properties['title']=="agua") {feature.properties['marker-color']='#FFCC33'}
                if(feature.properties['title']=="gas") { feature.properties['marker-color']='#653332'}
                if(feature.properties['title']=="internet") {feature.properties['marker-color']='#CC6633'}   
                if(feature.properties['title']=="cable") {feature.properties['marker-color']='#666535'}                         
