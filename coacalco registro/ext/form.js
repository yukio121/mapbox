$(function(){
    ...
    $('form').attr('action','https://docs.google.com/forms/d/1D4mFvpEvcbOz8tqZv1gvAWYDXtmjXzxGWnHEBG3pq4o/edit');
...
function Valida(formulario){
    ...
    if ($("#entry_1").val().length==0) {
        alert("Ingrese la Fecha del Pago atrasado");
        return false;
    } else if ($("#entry_4").val().length==0 ) {
        alert("Ingrese la Descripcion del Pago atrasado ");
        return false;
    } else {
